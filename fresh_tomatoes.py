...
<head>
    <meta charset="utf-8">
    <title>Adnan Jaffal's Top Movies!</title>
    <!-- Bootstrap 3 -->
...
movie_tile_content = '''
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer" data-storyline="{storyline}" data-cast="{cast}" data-rating="{rating}">
